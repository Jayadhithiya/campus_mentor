...
describe('Functional - FN021', function () {
  this.timeout(120000);

  it('Retrieve feedback score from Groq API response', async function () {
    ...
    if (!activity) {
      throw new Error('FN021 failed: App session disconnected');
    }
  });
});
