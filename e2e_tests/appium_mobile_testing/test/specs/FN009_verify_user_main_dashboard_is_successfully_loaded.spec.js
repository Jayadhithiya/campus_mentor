...
describe('Functional - FN009', function () {
  this.timeout(120000);

  it('Verify user main dashboard is successfully loaded', async function () {
    ...
    if (!activity) {
      throw new Error('FN009 failed: App session disconnected');
    }
  });
});
