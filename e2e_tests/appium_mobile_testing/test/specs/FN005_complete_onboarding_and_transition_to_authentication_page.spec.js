...
describe('Functional - FN005', function () {
  this.timeout(120000);

  it('Complete onboarding and transition to authentication page', async function () {
    ...
    if (!activity) {
      throw new Error('FN005 failed: App session disconnected');
    }
  });
});
