...
describe('Functional - FN030', function () {
  this.timeout(120000);

  it('Confirm sign out dialog returns user to login view', async function () {
    ...
    if (!activity) {
      throw new Error('FN030 failed: App session disconnected');
    }
  });
});
