...
describe('Functional - FN007', function () {
  this.timeout(120000);

  it('Register a new account with valid unique details', async function () {
    ...
    if (!activity) {
      throw new Error('FN007 failed: App session disconnected');
    }
  });
});
