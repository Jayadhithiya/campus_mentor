...
describe('UI UX - UI015', function () {
  this.timeout(120000);

  it('Verify typography scales and sizes across headings', async function () {
    ...
    if (!activity) {
      throw new Error('UI015 failed: App session disconnected');
    }
  });
});
