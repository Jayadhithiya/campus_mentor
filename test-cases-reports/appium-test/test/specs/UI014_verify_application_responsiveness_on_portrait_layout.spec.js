...
describe('UI UX - UI014', function () {
  this.timeout(120000);

  it('Verify application responsiveness on portrait layout', async function () {
    ...
    if (!activity) {
      throw new Error('UI014 failed: App session disconnected');
    }
  });
});
