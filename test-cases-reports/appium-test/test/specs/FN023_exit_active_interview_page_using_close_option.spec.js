...
describe('Functional - FN023', function () {
  this.timeout(120000);

  it('Exit active interview page using close option', async function () {
    ...
    if (!activity) {
      throw new Error('FN023 failed: App session disconnected');
    }
  });
});
